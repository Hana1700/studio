...
>((props, ref) => {
  ...
  const Comp = isMobile ? SheetPrimitiveTrigger : 'button';
...
>(
  (
    ...
    const icon = childNodes.find((child) => {
        ...
        // This is a bit of a hack, but it works for now to find the icon.
        // We can improve this later by using a more specific prop.
