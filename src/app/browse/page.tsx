...
async function getStructures(): Promise<Structure[]> {
    ...
    return structures.map(s => ({
        ...s,
        subDepartments: s.subDepartments, // This is already included
                ...
                <Link href={`/structure/${structure.id}`} key={structure.id} className="block">
                    <Card className="flex flex-col h-full hover:shadow-md transition-shadow">
                        <CardHeader>
                            ...
                            <CardDescription className="line-clamp-2">{structure.description || 'Pas de description'}</CardDescription>
                        </CardHeader>
